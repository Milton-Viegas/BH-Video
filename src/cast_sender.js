...
*/
    ...
    var Ea, y;
    a: {
        for (var Fa = ["CLOSURE_FLAGS"], z = r, Ga = 0; Ga < Fa.length; Ga++)
            if (z = z[Fa[Ga]],
            null == z) {
                y = null;
                break a
    ...
    var Ha = y && y[610401301];
    Ea = null != Ha ? Ha : !1;
    function Ia() {
        var a = r.navigator;
        return a && (a = a.userAgent) ? a : ""
    }
    var A, Ja = r.navigator;
    A = Ja ? Ja.userAgentData || null : null;
    function Ka(a) {
        return Ea ? A ? A.brands.some(function(b) {
    ...
    ;function C() {
        return Ea ? !!A && 0 < A.brands.length : !1
    }
    function La() {
        return C() ? Ka("Chromium") : (B("Chrome") || B("CriOS")) && !(C() ? 0 : B("Edge")) || B("Silk")
    }
    ;var Ma = {}
      , D = function(a, b) {
        this.g = b === Ma ? a : ""
    ...
    var Na = function(a) {
      ...
      , Oa = new D(r.trustedTypes && r.trustedTypes.emptyHTML || "",Ma);
    var Pa = {
        MATH: !0,
        SCRIPT: !0,
        STYLE: !0,
    ...
    var Sa = function(a) {
        ...
        return a.replace(Ra, function(d, e) {
            var g = b[d];
            if (g)
                return g;
            ...
            if (!g) {
                ...
                g = new D(g,Ma);
                if (c.tagName && Pa[c.tagName.toUpperCase()])
    ...
    ;
    f.cc = function(a, b, c) {
        0 > Ua(this, a) || E.o(this, "QUEUE_REMOVE", new chrome.cast.media.va([a]), b, c, chrome.cast.media.timeout.v)
    }
    ;
    f.ec = function(a, b, c) {
    ...
    f.qc = function(a, b, c) {
        var d = E;
        a = new Wa(new chrome.cast.Volume(a,null),this.receiver.volume);
        d.setReceiverVolume(this.sessionId, a, b, c)
    }
    ;
    f.pc = function(a, b, c) {
        a = new Wa(new chrome.cast.Volume(null,a),this.receiver.volume);
    ...
    ;
    f.stop = function(a, b) {
        E.Ea(new Xa(this.sessionId), a, b, chrome.cast.timeout.stopSession)
    }
    ;
    f.sendMessage = function(a, b, c, d) {
        E.mc(new Va(this.sessionId,a,b), c, d)
    }
    ;
    f.Y = function(a) {
    ...
    var $a = Object.freeze || function(a) {
        return a
    }
    ;
    var F = function() {};
    ...
    f.forEach = function(a, b) {
        for (var c = db(this), d = 0; d < c.length; d++) {
            var e = c[d]
              , g = this.get(e);
            a.call(b, g, e, this)
        }
    ...
    ;
    f.keys = function() {
        return cb(this.s(!0)).h()
    }
    ;
    f.values = function() {
        return cb(this.s(!1)).h()
    }
    ;
    f.entries = function() {
        var a = this;
    ...
    P.prototype.connect = function(a) {
        ...
        ib(this, new O("client_connect",this.h))
    }
    ;
    ...
    var lb = function(a, b, c, d, e, g, k, l, q, w, sb, tb) {
        this.J = a;
        this.g = b || null;
        this.j = c || null;
        this.B = d || null;
      ...
      , mb = function(a) {
        ...
        a.h && b.push(kb(new jb(a.h,a.I,a.g)));
        return b
    };
    var nb = function() {
        this.g = {};
    ...
    ;
    var ub = B("Gecko") && !(-1 != Ia().toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge")
      , vb = -1 != Ia().toLowerCase().indexOf("webkit") && !B("Edge");
    try {
    ...
    R.prototype.A = function(a) {
        this.m = arguments;
        this.g || this.j ? this.h = !0 : xb(this)
    }
    ;
    ...
    !B("Android") || La();
    La();
    B("Safari") && (La() || (C() ? 0 : B("Coast")) || (C() ? 0 : B("Opera")) || (C() ? 0 : B("Edge")) || (C() ? Ka("Microsoft Edge") : B("Edg/")) || C() && Ka("Opera"));
    var yb = {}
      , S = null
      , zb = ub || vb || "function" == typeof r.btoa
      , Ab = function(a) {
        if (zb)
            var b = r.btoa(a);
        else {
    ...
    var V = function() {
      ...
      , W = function(a, b, c, d) {
        ...
        d = ib(a.A, b);
        c && d && (a = hb(a.K, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER,d),
        (a = a.g) && a(b))
    };
    ...
    var Y = function(a, b, c) {
        ...
        b.onclose = function(d) {
            ...
            switch (d.reason) {
            case "closed":
                Db(a, chrome.cast.L.DISCONNECTED);
                break;
            case "error":
      ...
      , Gb = function(a) {
        var b = Z;
        Eb.has(a.type) && b.ja && (b.m ? (a.sessionId = b.m,
        Fb(b, null, a.type, a, function() {}, function() {})) : b.Va.A(X(b, void 0, "urn:x-cast:com.google.cast.media", a)))
    };
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName,
        (g = k.launchParameter) && !g.match(Hb) && (g = Ab(g)));
        var l = [];
        l.push({
            appId: b.appId,
        ...
        return mb(new lb(l,a.A.h,a.g.autoJoinPolicy,a.g.defaultActionPolicy,b.requestSessionTimeout,e,g,a.g.invisibleSender,c,d,b.androidReceiverCompatible,b.credentialsData))
    };
    V.prototype.Fa = function(a, b, c, d) {
        var e = this;
        this.D++;
        Fb(this, null, b, a, function(g) {
            e.D--;
            g.j = !0;
            c && c(g)
        }, function(g) {
    ...
    V.prototype.onMessage = function(a) {
        ...
        case "new_session":
        case "update_session":
            a.message = qb(this.H, a.message);
            break;
        case "v2_message":
            var b = a.message;
            b && "MEDIA_STATUS" == b.type && b.status && (b.status = b.status.map(this.Wa))
        }
        if (b = hb(this.K, a.sequenceNumber))
    ...
    chrome.cast.unescape = function(a) {
        return -1 != a.indexOf("&") ? "document"in r ? Sa(a) : Ta(a) : a
    }
    ;
